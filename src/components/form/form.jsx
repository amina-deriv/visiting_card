...
const SignupSchema = Yup.object().shape({
    firstName: Yup.string().min(3, "Too Short Name!").max(25, "Too Long Name!").required("First Name is Required"),
    lastName: Yup.string().min(2, "Too Short Name!").max(50, "Too Long Name!").required("Last Name is Required"),
    jobTitle: Yup.string().required("Please specify your job Title"),
    email: Yup.string().email("Invalid email").required("Email is required"),
    mobile: Yup.string()
        .matches(/^\+?((-|\s)*[0-9])*$/, "Phone number is not valid")
        .required("Required"),
                ...
                {({
                    ...
                    <StyledForm onSubmit={handleSubmit}>
                        ...
                        <StyledField>
                            ...
                            {errors.jobTitle && touched.jobTitle ? <Error>{errors.jobTitle}</Error> : null}
                        </StyledField>
                        ...
                        <StyledField>
                            ...
                            {errors.mobile && touched.mobile ? <Error>{errors.mobile}</Error> : null}
                        </StyledField>
                        ...
                        <div className="button-field">
                            <button className={isSubmitting ? "active" : "inactive"} type="submit">
                                Submit
                            </button>
                            <button className={isSubmitting ? "active" : "inactive"} type="reset" onClick={resetForm}>
                                Clear
                            </button>
                        </div>
                    </StyledForm>
